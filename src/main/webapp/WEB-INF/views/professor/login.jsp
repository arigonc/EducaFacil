	...
	<div class="container col-xl-10 col-xxl-8 px-4">
		<div class="row align-items-center g-lg-5 py-5">
			<div class="col-lg-7 text-center text-lg-start">
				...
				<h2 class="fw-bold lh-1 mb-3 text-white">Para professores</h2>
				<p class="col-lg-10 fs-4 text-white">Compartilhe aulas e
					atividades nas salas virtuais para seus alunos! Faça parte da
					melhor plataforma educacional brasileira!</p>
			</div>
			<div class="col-md-10 mx-auto col-lg-5">
				<div class="card border-0 shadow rounded-3 my-3">
					<div class="card-body p-4 p-sm-5 p-3">
						...
						<form action="professor?action=login" method="post"
							id="formLoginUsuario">
							...
							<div class="form-check p-1 mb-3">
								<a href="professor?action=cadastrarConta">Ainda não sou
									cadastrado</a>
							</div>
						</form>
