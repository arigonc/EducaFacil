			...
			<div class="card text-bg-success mb-3" style="max-width: 18rem;">
				<div class="card-body d-flex">
					...
					<p class="card-text text-end">
						<b>${num_salas}</b> salas que você participa ativamente.
					</p>
				</div>
			</div>
		</div>
		...
		<div class="col">
			<div class="card text-bg-danger mb-3" style="max-width: 18rem;">
				<div class="card-body d-flex">
					...
					<p class="card-text text-end">
						<b>${num_atividades_respondidas}</b> atividades foram respondidas
						por você em todas as suas salas.
					</p>
				</div>
			</div>
		</div>
		...
		<div class="col-md-6">
			<div class="card border-0 shadow rounded-3 my-3">
				<div class="card-body p-4 p-sm-5 p-3">
					...
					<form action="aluno?action=editarConta" method="post"
						id="formPerfilContaUsuario">
						<div class="form-floating mb-3">
							<input type="email" class="form-control" id="email"
								placeholder="Email..." value="${sessionScope.alunoLogado.email}"
								disabled> <label for="email">Email</label>
						</div>
						<div class="form-floating mb-3">
							<input type="text" class="form-control" id="nome" name="nome"
								placeholder="Nome..." value="${sessionScope.alunoLogado.nome}">
		...
		<div class="col-md-6">
			<div class="card border-0 shadow rounded-3 my-3">
				<div class="card-body p-4 p-sm-5 p-3">
					...
					<form action="aluno?action=editarSenha" method="post"
						id="formPerfilSenhaUsuario">
						<div class="form-floating mb-3">
							<input type="password" class="form-control" id="senha"
								name="senha" placeholder="Senha..."
								value="${sessionScope.alunoLogado.senha}"> <label
			...
			<div class="modal-content">
				...
				<div class="modal-footer">
					...
					<a type="button" class="btn btn-danger"
						href="aluno?action=removerConta">Remover</a>
				</div>
			</div>
		</div>
	</div>
